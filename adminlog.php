...
<body>
    <div class="wrapper" style="width: 35%;">
        <form action="adminlog.php" method="POST">
            ...
            <br>
          <CENTER> <div style="width: 85%;" class="input-box">
                <input type="text" style="width: 100%;" name="username" placeholder="Nom d'Utilisateur" required>
            </div>
            <div style="width: 85%;" class="input-box">
                <input type="password" style="width: 100%;" name="password" placeholder="Mots de Passe" required>
            </div></CENTER>
            <center><button type="submit" class="btn">Connexion</button></center>
            <br>
